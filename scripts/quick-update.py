#!/usr/bin/env python3
"""
Quick update script for events.json
Fetches a limited number of tweets and updates events.json
"""
...
def main():
    ...
    for keyword in KEYWORDS:
        ...
        for tweet in tweets:
            ...
            event = {
                "id": tweet_id,
                "type": "intel",  # Default type
                "country": "israel",  # Default country
                "title": tweet.get("text", "")[:100],
                "desc": tweet.get("text", ""),
                "location": [32.0, 35.0],  # Default location (Israel)
                "locationName": "以色列",
